...
-- 3. INSERIR TIPOS DE PROCESSO (usando gen_random_uuid())
INSERT INTO tipos_processo (nome, descricao, ativo) VALUES
('trabalhista', 'Reclamações e ações trabalhistas', true),
('rescisao_indireta', 'Processos de rescisão indireta', true),
('dano_moral', 'Ações de danos morais', true),
('equiparacao_salarial', 'Processos de equiparação salarial', true),
('horas_extras', 'Cobrança de horas extras', true);
...
('João Silva Santos', '12345', 'TRT-2024-001', 'Reclamação trabalhista - horas extras não pagas', 'pendente', '2024-02-28 10:00:00', '2024-02-25 14:00:00', 'trabalhista', 'Documentos coletados. Aguardando audiência.'),
('Maria Oliveira Costa', '67890', 'TRT-2024-002', 'Processo de rescisão indireta por assédio moral', 'novo', '2024-03-15 10:00:00', '2024-03-10 09:00:00', 'rescisao_indireta', 'Testemunhas identificadas.'),
('Carlos Mendes Silva', '11111', 'TRT-2024-003', 'Ação de danos morais', 'concluido', '2024-01-30 10:00:00', '2024-01-25 15:00:00', 'dano_moral', 'Processo concluído com acordo.'),
('Ana Paula Ferreira', '22222', 'TRT-2024-004', 'Equiparação salarial', 'atrasado', '2024-01-15 10:00:00', '2024-01-10 11:00:00', 'equiparacao_salarial', 'URGENTE: Prazo vencido.'),
('Roberto Silva Nunes', '33333', 'TRT-2024-005', 'Acidente de trabalho', 'pendente', '2024-03-25 10:00:00', '2024-03-22 16:00:00', 'trabalhista', 'CAT emitida.'),
('Carla Rodrigues Lima', '44444', 'TRT-2024-006', 'Assédio moral', 'novo', '2024-04-15 10:00:00', '2024-04-12 13:00:00', 'dano_moral', 'Relatos coletados.'),
('Ricardo Mendes Costa', '55555', 'TRT-2024-007', 'Horas extras', 'pendente', '2024-03-30 10:00:00', '2024-03-28 10:30:00', 'horas_extras', 'Análise de ponto finalizada.'),
('Juliana Oliveira Santos', '66666', 'TRT-2024-008', 'Adicional de periculosidade', 'novo', '2024-04-20 10:00:00', '2024-04-18 14:30:00', 'trabalhista', 'Vistoria técnica solicitada.');
...
SELECT 'TABELA' as info, 'TOTAL' as quantidade
UNION ALL
SELECT 'USUÁRIOS', COUNT(*)::text FROM users
UNION ALL
SELECT 'FUNCIONÁRIOS', COUNT(*)::text FROM employees  
UNION ALL
SELECT 'CASOS', COUNT(*)::text FROM cases
UNION ALL
SELECT 'TIPOS PROCESSO', COUNT(*)::text FROM tipos_processo
UNION ALL
SELECT 'LOGS', COUNT(*)::text FROM activity_log;

-- Verificação detalhada
SELECT '=== FUNCIONÁRIOS POR EMPRESA ===' as titulo;
SELECT empresa as codigo_empresa, COUNT(*) as total FROM employees GROUP BY empresa ORDER BY empresa;

SELECT '=== CASOS POR STATUS ===' as titulo;  
