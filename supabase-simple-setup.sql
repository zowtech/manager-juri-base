-- SCRIPT SUPABASE SIMPLES - SEM FOREIGN KEYS
...
-- 7. Inserir usuário admin (senha: admin123)
...
CREATE INDEX idx_cases_matricula ON cases(matricula);
...
UNION ALL
SELECT 'cases' as tabela, count(*) as registros FROM cases
UNION ALL  
